...
namespace NS_Comp_Svc
{
	...
	public:
		...
		void creerClient(System::String^, System::String^, System::String^, System::String, System::String^, System::String^, System::String, System::String^, System::String^, System::String^);
