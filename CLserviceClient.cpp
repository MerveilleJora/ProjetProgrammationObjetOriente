...
void NS_Comp_Svc::CLserviceClient::creerClient(System::String^ Nom, System::String^ Prenom, System::String^ AdresseFacturation, System::String^ CPAdresseFacturation, System::String^ VilleAdresseFacturation, System::String^ AdresseLivraison, System::String^ CPAdresseLivraison, System::String^ VilleAdresseLivraison, System::String^ DateN, System::String^ DateA)
{
	System::String^ sSql;
